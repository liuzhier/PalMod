...
declare global {
    ...
    * @param fbp 战斗环境编号
    */
    function SetBattlefield(fbp: Fbp): void;
    ...
    * @param speed 淡入速度
    */
    function FadeFbp(fbp: Fbp, speed: ushort): void;
    ...
    */
    function ScrollFbp(fbp: Fbp, speed: ushort): void;
    ...
    */
    function ShowFbpWithSprite(fbp: Fbp, spriteId: ushort, speed: ushort): void;
